...
function Header(props) {
    ...
    function handleClick(link) { // called on every click
        navigate(link);
        loadReducer();
    };
                    ...
                    <Tilt>
                        <div>
                            ...
                            <nav className='nav-panel'>
                                ...
                                ><FaSuitcase />{'\u00A0'}
                                    <Link to="/portfolio">  Porfolio</Link></li>
                                {/* <li><FaHandsHelping />{'\u00A0'}
                        ...
                        <div>
                            <nav className='nav-panel-m'>
                                <li onClick={() => handleClick("/")} className={activeTabId === 1 ? 'active-btn-m' : ''}>
                                    <Link to="/">  <FaInfo /></Link></li>
                                <li onClick={() => handleClick("/blog")} className={activeTabId === 3 ? 'active-btn-m' : ''} >
                                    <Link to="/blog">  <FaCopy /></Link></li>
                                <li onClick={() => handleClick("/portfolio")} className={activeTabId === 2 ? 'active-btn-m' : ''}>
                                    <Link to="/portfolio">  <FaSuitcase /></Link></li>

...
You are part of a FAANG-scale e-commerce backend platform that handles millions of requests daily. The platform is microservices-based, and observability is crucial for debugging, tracing latency issues, and monitoring API performance.

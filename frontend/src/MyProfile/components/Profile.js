            ...
            <Grid style={{ zIndex: 100 }} container direction={isSmallScreen ? 'column' : 'row'} spacing={2} columns={12}>
                ...
                <Grid item xs={8}>
                    ...
                    <Item sx={{ background: 'white', textAlign: 'left', padding: '20px 30px', backdropFilter: 'blur(50px)' }}>
                        ...
                        {/* AirPointer - Advanced Pointer Control Solution */}
                        <List>
                            <ListItem sx={{ padding: 0 }}>
                                <Card sx={{ maxWidth: '800px', marginBottom: 4 }}>
                                    <CardMedia
                                        ...
                                        height="200"
                                        image={AirPointer}
                                        alt="AirPointer Project Preview"
                                    />
                                    <CardContent>
                                        <Typography gutterBottom variant="h6" component="div">
                                            🖱️ AirPointer - Hands-Free Pointer Control Solution
                                        </Typography>
                                        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                                            AirPointer is an innovative <strong>gesture-based pointer control</strong> solution designed to provide
                                            an intuitive and hands-free way to interact with devices. By leveraging <strong>computer vision and AI</strong>,
                                            it enables users to navigate screens, control presentations, and interact with digital environments
                                        ...
                                        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                                            Traditional mouse and trackpad interactions have limitations, especially for professionals giving
                                            presentations, individuals with accessibility needs, or gamers looking for more immersive controls.
                                            AirPointer eliminates physical constraints by providing <strong>precise gesture-based control</strong>.
                                        </Typography>

                                        <Typography variant="body2" sx={{ color: 'text.secondary', marginTop: 2 }}>
                                            <strong>Key Features:</strong>
                                            <ul>
                                                <li>✅ <strong>Gesture-Based Control</strong> – Navigate screens with hand movements instead of a mouse.</li>
                                                <li>✅ <strong>AI-Powered Precision</strong> – Uses <strong>computer vision algorithms</strong> for real-time gesture recognition.</li>
                                                <li>✅ <strong>Seamless Presentation Mode</strong> – Effortlessly switch slides with natural gestures.</li>
                                                <li>✅ <strong>Multi-Device Compatibility</strong> – Works across desktops, laptops, and smart TVs.</li>
                                                <li>🔜 <strong>Upcoming Feature:</strong> Custom Gesture Mapping – Personalize gestures for specific actions.</li>
                                            </ul>
                                        </Typography>

                                        <Typography variant="body2" sx={{ color: 'text.secondary', marginTop: 2 }}>
                                            <strong>TL;DR:</strong> AirPointer is a <strong>gesture-based pointer control solution</strong> that brings intuitive, hands-free interaction
                                            to presentations, accessibility, and immersive digital experiences.
                                        </Typography>
                                    </CardContent>
                                    ...
                                    <CardActions>
                                        <Button
                                            ...
                                            variant="outlined"
                                            color="primary"
                                            href="https://github.com/mrajkishor/AirPointer"
                                            target="_blank"
                                        >
                                            View Project
                                        </Button>

...
This architecture enables efficient bulk data transfers (like disk-to-memory), reducing CPU load significantly. Let me know if you want a timing diagram too.
